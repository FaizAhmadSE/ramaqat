...
<div class="container mt-5" id="add_cource_scroll">
    <form id="course_formss" method="POST" action="{{ route('course_data') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-6">
                <div class="form-group" style="padding-top: 30px">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputGroupFile02" accept="image/*" onchange="loadFile(event)" name="image">
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group bmd-form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="promo_video" accept="video/*" required>
            ...
            <div class="col-6">
                <div class="form-group bmd-form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <input type="file" class="custom-file-input" id="inputGroupFile03" aria-describedby="inputGroupFileAddon01" name="attachment[]" accept="application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/msword,image/*" multiple>
        ...
        <div class="modal-content">
            <div class="modal-header plum-bg">
                <ul class="header-list">
                    <li>
                        <div>
                            <h5 class="modal-title" id="exampleModalLabel"><b>Courese Content</b></h5>
                        </div>
